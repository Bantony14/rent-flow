...
import { forgotPassword, resetPassword, verifyEmailOtp } from "../api/authApi.js";
...
function Forgotpassword() {
    ...
    async function otpSending() {
        ...
        try {
            ...
            toast.success(`opt Send Successfull please check your this email ${email}`)
            setOtpTrigger(true)
    ...
    async function updatePassword() {
        ...
        try {
            const res = await resetPassword(email, otp.join(""), newPassword, confirmPassword);
            toast.success(res?.data?.message);
            navigate("/Login")
