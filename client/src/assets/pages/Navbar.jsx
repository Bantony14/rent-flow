            ...
            <div className="flex flex-col gap-4">
              {user ? (
                <>
                  <Button
                    onClick={() => logOut()}
                    className="w-full px-5 py-3 rounded-2xl border border-zinc-700 bg-red-900/70 hover:bg-zinc-800 hover:border-cyan-500 transition duration-300 text-sm font-medium"
                  >
                    Logout
                  </Button>
                  {/* THIS IS PROTAL */}
              ...
              {user.role === "ADMIN" && (
                <Button className=" xl:block px-5 py-2.5 rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold hover:scale-105 transition duration-300 shadow-xl shadow-cyan-500/30">
                  <NavLink
                    to="/admin/dashboard"
                    className={({ isActive }) =>
                      isActive ? "text-cyan-400 font-bold" : "text-white"
