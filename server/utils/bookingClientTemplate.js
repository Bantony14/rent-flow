    ...
    >
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="right" style="vertical-align: middle;">
                ...
                ">📋 &nbsp;BOOKING REQUEST</div>
                <div style="margin-top: 8px; color: #64748b; font-size: 11px; text-align: right;">Room Booking Confirmation</div>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td style="padding: 28px 36px 26px;">
            ...
            <tr>
              <td>
                ...
                <div style="font-size: 13px; color: #64748b; line-height: 1.7; max-width: 460px;">
                  Hello <strong style="color: #1e293b;">${userName}</strong>, your booking request for <strong style="color: #2563eb;">Room ${roomName}</strong> at <strong style="color: #1e293b;">${buildingName}</strong> has been received. The owner will review and contact you shortly.
                </div>
              </td>
              <td align="right" style="vertical-align: top;">
                <div style="
                  ...
                  white-space: nowrap;
                ">
                  <div style="font-size: 10px; color: #2563eb; font-weight: 700; letter-spacing: 0.6px; text-transform: uppercase; margin-bottom: 3px;">Requested On</div>
          ...
          <!-- Your Details -->
          <div style="font-size:10px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:#94a3b8; margin-bottom:8px;">Your Submitted Details</div>
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0; border-radius:10px; overflow:hidden; margin-bottom:22px;">
            <tr>
              <td style="background:#f8fafc; padding:9px 14px; width:30%; font-size:12px; font-weight:700; color:#475569; border-bottom:1px solid #e2e8f0;">Full Name</td>
              <td style="padding:9px 14px; font-size:12px; color:#1e293b; font-weight:600; border-bottom:1px solid #e2e8f0;">${userName}</td>
            </tr>
            <tr>
              <td style="background:#f8fafc; padding:9px 14px; font-size:12px; font-weight:700; color:#475569; border-bottom:1px solid #e2e8f0;">Email</td>
              <td style="padding:9px 14px; font-size:12px; color:#1e293b; font-weight:600; border-bottom:1px solid #e2e8f0;">${userEmail}</td>
            </tr>
            <tr>
              <td style="background:#f8fafc; padding:9px 14px; font-size:12px; font-weight:700; color:#475569;">Mobile</td>
              <td style="padding:9px 14px; font-size:12px; color:#1e293b; font-weight:600;">${userMobile}</td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:22px;">
            <tr>
              <td style="
                ...
                padding:10px 14px;
              ">
                <span style="font-size:12px; color:#1e40af; line-height:1.6;">
                  📌 This is a confirmation that your booking request has been submitted. The property owner will review your request and contact you on <strong>${userMobile}</strong> or <strong>${userEmail}</strong>.
                </span>
              </td>
            </tr>
          </table>
...
export default bookingClientTemplate;
